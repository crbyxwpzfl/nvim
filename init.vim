...
"LOOP AUTORELOAD FILE AND SYNC CURSOR
	...
	augroup Execute_On_VimEnter "initialisiert sync des cursurs
		autocmd!
		"autocmd VimEnter * call writefile([1], "C:\\Users\\roess\\Desktop\\onedrive\\utils\\nvim\\alt.txt", "b") "alt = 1 
		autocmd VimEnter * call Reset_Sync()
	augroup END

	function Reset_Sync()
		call writefile([1], "C:\\Users\\roess\\Desktop\\onedrive\\utils\\nvim\\alt.txt", "b") "alt = 1 
		let master = readfile("C:\\Users\\roess\\Desktop\\onedrive\\utils\\nvim\\master.txt")[0]
		if master > line('$')
	...
	function! BitteGeh()
		...
		let master = readfile("C:\\Users\\roess\\Desktop\\onedrive\\utils\\nvim\\master.txt")[0]
		let alt = readfile("C:\\Users\\roess\\Desktop\\onedrive\\utils\\nvim\\alt.txt")[0]
		...
		if master == alt
			...
			if master <= line('$') "also erste zeile >= master >= lezte zeile
				if master != pos
					call writefile([pos], "C:\\Users\\roess\\Desktop\\onedrive\\utils\\nvim\\master.txt", "b") "master = pos 
				endif
			endif
		endif
			...
			if alt != pos
				...
				if master != pos
					if alt > line('$') && master <= line('$') "alt tiefer als lezte zeile und erste zeile >= master >= lezte zeile
						...
						call writefile([master], "C:\\Users\\roess\\Desktop\\onedrive\\utils\\nvim\\alt.txt", "b") "alt = master
